...
export class Base {
    ...
    async getNewsWidget(date: Date, validateSession = true): Promise<NewsWidget> {
        ...
        const response = await this.axios({
            method: 'GET',
            url: `/WebUntis/api/public/news/newsWidgetData;jsessionid=` + this.sessionInformation!.sessionId,
            params: {
    ...
    async getInbox(validateSession = true): Promise<Inbox> {
        ...
        const response = await this.axios({
            method: 'GET',
            url: `/WebUntis/api/rest/view/v1/messages;jsessionid=` + this.sessionInformation!.sessionId,
            headers: {
    ...
    async _getJWT(validateSession = true): Promise<string> {
        if (validateSession && !(await this.validateSession())) throw new Error('Current Session is not valid');
        document.cookie = this._buildCookies();
        const response = await this.axios({
            method: 'GET',
            url: `/WebUntis/api/token/new;jsessionid=` + this.sessionInformation!.sessionId,
            headers: {
    ...
    async validateSession(): Promise<boolean> {
        ...
        const response = await this.axios({
            method: 'POST',
            url: `/WebUntis/jsonrpc.do;jsessionid=` + this.sessionInformation.sessionId,
            params: {
                school: this.school,
            },
            headers: {
    ...
    async getHomeWorksFor(rangeStart: Date, rangeEnd: Date, validateSession = true): Promise<Homework[]> {
        ...
        const response = await this.axios({
            method: 'GET',
            url: `/WebUntis/api/homeworks/lessons;jsessionid=` + this.sessionInformation!.sessionId,
            params: {
    ...
    async getExamsForRange(
        ...
        const response = await this.axios({
            method: 'GET',
            url: `/WebUntis/api/exams;jsessionid=` + this.sessionInformation!.sessionId,
            params: {
                startDate: Base.convertDateToUntis(rangeStart),
                endDate: Base.convertDateToUntis(rangeEnd),
                klasseId: klasseId,
    ...
    async getTimetableForWeek(
        ...
        const response = await this.axios({
            method: 'GET',
            url: `/WebUntis/api/public/timetable/weekly/data;jsessionid=` + this.sessionInformation!.sessionId,
            params: {
                elementType: type,
                elementId: id,
    ...
    async _request<Response = Record<string, any>>(
        ...
        const response = await this.axios({
            method: 'POST',
            url: url + `;jsessionid=` + this.sessionInformation!.sessionId,
            params: {
                school: this.school,
            },
            headers: {
    ...
    async getAbsentLesson(
        ...
        const response = await this.axios({
            method: 'GET',
            url: `/WebUntis/api/classreg/absences/students;jsessionid=` + this.sessionInformation!.sessionId,
            params: {
                startDate: Base.convertDateToUntis(rangeStart),
                endDate: Base.convertDateToUntis(rangeEnd),
    ...
    async getPdfOfAbsentLesson(
        ...
        const response = await this.axios({
            method: 'GET',
            url: `/WebUntis/reports.do;jsessionid=` + this.sessionInformation!.sessionId,
            params: {
                name: 'Excuse',
                format: 'pdf',
...
export class InternalWebuntisSecretLogin extends Base {
    ...
    async _otpLogin(token: number | string, username: string, time: number, skipSessionInfo = false) {
        const response = await this.axios({
            method: 'POST',
            url: '/WebUntis/jsonrpc_intern.do;jsessionid=' + this.sessionInformation!.sessionId,
            params: {
                m: 'getUserData2017',
                school: this.school,
                v: 'i2.2',
        ...
        const appConfigUrl = `/WebUntis/api/app/config;jsessionid=` + this.sessionInformation!.sessionId;
        ...
        // Get klasseId
        try {
            const dayConfigUrl = `/WebUntis/api/daytimetable/config;jsessionid=` + this.sessionInformation!.sessionId;
